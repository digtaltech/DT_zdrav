...
public class FetchDataList extends AsyncTask<Void,Void,Void> {
    public String data ="";
    public JSONArray JA;
    public Map<Integer, DataMarker> arrayListData = new HashMap<>();
    public Map<Integer,ArrayList<String>> listMap = new HashMap<>();
    @Override
    protected Void doInBackground(Void... voids) {
        /*try {
           // URL url = new URL("https://api.myjson.com/bins/n00hx");//https://api.myjson.com/bins/xpen3 http://169.254.190.175/v1/Api.php?apicall=getmarker
           ...
           // BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(inputStream));
            ...
            MenuActivity.array = new HashMap<>();
            for (int i = 0; i < JA.length(); i++) {
                ...
                MenuActivity.array.put(JO.get("MarkerName").toString(),JO.get("Coment").toString());
            }
...
*/
        ...
        *///} catch (JSONException e) {
        ...
        for (int i = 0; i < strings.length; i++) {
            ...
            arrayList.add(0,dataMarker.getMarkerName());
            arrayList.add(1,dataMarker.getComent());
            listMap.put(i,arrayList);
        }
    }
}
